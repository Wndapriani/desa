    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card-header">
                <h3 class="card-title">
                    <i class="fa fa-table"></i> Surat Pindah
                </h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">
                            <i class="fa fa-file"></i> Su-Ket Pindah
                        </h3>
                    </div>
                    <form action="<?= base_url('surat-cetak/pindah') ?>" method="get" enctype="multipart/form-data">
                        <div class="card-body">
